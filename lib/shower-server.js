...
exports.initExpressStatic = function (presentations, app, dirname) {
    ...
    presentations.forEach(function (presentation) {
        ...
        app.get(url, function (req, res) {
            var transformHeadStream = utils.getStringReplaceStream(/<\/head>/, '<script src="/socket.io/socket.io.js"></script></head>'),
                transformBodyStream = utils.getStringReplaceStream(/<\/body>/, '<script type="text/javascript" src="/client.js"></script></body>');
